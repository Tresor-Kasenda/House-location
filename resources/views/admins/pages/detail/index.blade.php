                            ...
                            <div class="toggle-expand-content" data-content="pageMenu">
                                <ul class="nk-block-tools g-3">
                                    <li class="preview-item">
                                        <a href="{{ route('admins.details.create') }}" class="btn btn-dim btn-primary btn-sm">
                            ...
                            <table class="datatable-init nowrap nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                <thead>
                                    <tr class="nk-tb-item nk-tb-head text-center">
                                        ...
                                        <th class="nk-tb-col tb-col-md">
                                            <span class="sub-text">Nbre Jours electricite</span>
                                        </th>
                                        <th class="nk-tb-col tb-col-md">
                                            <span class="sub-text">Nbre des sallons</span>
                                        </th>
                                        <th class="nk-tb-col tb-col-md">
                                            <span class="sub-text">Type de toilette</span>
                                        </th>
                                        <th class="nk-tb-col tb-col-md">
                                                        ...
                                                        <div class="drodown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <ul class="link-list-opt no-bdr">
                                                                    <li>
                                                                        <a href="{{ route('admins.details.edit', $detail->key) }}">
                                                                            <em class="icon ni ni-edit"></em>
                                                                            <span>Editer</span>
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <form action="{{ route('admins.details.destroy', $detail->key) }}" method="POST" onsubmit="return confirm('Voulez vous supprimer');">
                                                                            @method('DELETE')
