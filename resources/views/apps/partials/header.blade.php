<header class="w-full lg:px-28 sm:px-12 px-6 relative lg:after:absolute lg:after:bottom-0 bg-white z-50 after:max-w-7xl after:h-0 after:left-1/2 after:-translate-x-1/2 after:bg-gradient-to-tr after:from-green-400 after:to-purple-600 shadow-md shadow-purple-100 lg:shadow-none lg:after:w-9/12 after:z-40">
    <nav class="container m-auto h-16 md:h-20 py-4 flex items-center justify-between">
        ...
        <div id="menuMob"
            ...
            <div
                class="relative h-2 w-36 mx-auto before:absolute before:top-1/2 before:-translate-y-1/2 before:bg-gray-400 before:w-full before:h-[1px] before:left-1/2 before:-translate-x-1/2">
            </div>
        ...
        <div class="flex gap-3 sm:gap-1 items-center relative">
            <div
                class="flex lg:flex items-center lg:gap-3 relative lg:before:absolute lg:before:w-full lg:before:h-full before:lg:-top-4 lg:before:left-0 lg:before:bg-gray-00 lg:p-4 lg:before:rounded-b-xl before:z-10 lg:before:border lg:before:bg-gray-100">
                <button id="toggleSearchBox"
                        class="bg-gray-100 p-3 rounded-xl transition-all hover:bg-gray-100 hover:text-purple-600 duration-300 z-50">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                         stroke="currentColor"
                         stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <a href=""
                   class="sm:p-3 rounded-xl transition-all bg-gray-100 hover:text-purple-600 duration-300 hidden lg:flex lg:z-50">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                         stroke="currentColor"
                         stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <button id="btnHumberger"
                    class="z-[1000] relative flex flex-col justify-between h-5 w-5 transition duration-300 rotate-0 lg:hidden">
