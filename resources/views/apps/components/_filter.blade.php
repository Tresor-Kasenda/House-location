    ...
    <div>
        ...
        <ul class="space-y-2 mt-4">
            <li class="space-x-4 flex items-center">
                <input type="radio" id="out" name="wc"
                       class="text-purple-500 focus:ring-purple-400 ">
                <label for="out">Extérieur</label>
            </li>

            <li class="space-x-4 flex items-center">
                <input type="radio" id="in" name="wc"
                       class="text-purple-500 focus:ring-purple-400 ">
                <label for="in">Intérieur</label>
            </li>

            <li class="space-x-4 flex items-center">
                <input type="radio" id="outin" name="wc"
                       class="text-purple-500 focus:ring-purple-400 ">
    ...
    <div>
        ...
        <ul class="flex gap-4 mt-4">
            <li>
                ...
                <label title="Une pièce" for="1"
                       class="h-8 w-8 rounded-full flex justify-center items-center bg-p-100 text-purple-700 peer-checked:bg-purple-500 ring-2 ring-offset-2 ring-gray-200 peer-checked:text-white peer-checked:ring-purple-400 ring-offset-white cursor-pointer transition">
            ...
            <li>
                ...
                <label title="Trois pièces" for="3"
                       class="h-8 w-8 rounded-full flex justify-center items-center bg-p-100 text-purple-700 peer-checked:bg-purple-500 ring-2 ring-offset-2 ring-gray-200 peer-checked:text-white peer-checked:ring-purple-400 ring-offset-white cursor-pointer transition">
            ...
            <li>
                ...
                <label title="Quatre pièces" for="4"
                       class="h-8 w-8 rounded-full flex justify-center items-center bg-p-100 text-purple-700 peer-checked:bg-purple-500 ring-2 ring-offset-2 ring-gray-200 peer-checked:text-white peer-checked:ring-purple-400 ring-offset-white cursor-pointer transition">
            ...
            <li>
                <input type="radio" name="rooms" id="+4" class="hidden peer">
                <label title="Plus de quatre" for="+4"
                       class="h-8 w-8 rounded-full flex justify-center items-center bg-p-100 text-purple-700 peer-checked:bg-purple-500 ring-2 ring-offset-2 ring-gray-200 peer-checked:text-white peer-checked:ring-purple-400 ring-offset-white cursor-pointer transition">
                    <span class="text-base font-semibold">+4</span>
                </label>
            </li>
