            ...
            <div class="container m-auto py-8 overflow-x-auto">
                <div class="md:w-full w-[130vh] md:h-full h-[60vh] md:pl-0 md:pr-0 pl-8 pr-4 grid grid-cols-12 grid-rows-4 gap-4">
                    ...
                    <div class="relative lg:col-span-6 md:col-span-8 col-span-4 row-span-4 lg:h-[31rem] md:h-[25rem] group transition">
                                    ...
                                    <div class="md:flex justify-between pb-8">
                                        <div>
                                            ...
                                            <span class="text-sm text-gray-200">
                                                A 56 minutes de votre position actuelle.</span>
                                        </div>

                                        <div class="md:mt-0 mt-4">
                                            <h3 class="text-3xl md:text-right font-bold text-purple-400">{{ $apartments[0]->pricecs }} $</h3>
                        ...
                        <img src="{{ asset('storage/'.$apartments[0]->images) }}" class="w-full h-full  lg:rounded-l-2xl md:rounded-tl-2xl md:rounded-r-none md:rounded-bl-none rounded-2xl object-cover" alt="{{ $apartments[0]->commune }}">
                    </div>
                    ...
                    <div class="relative lg:col-span-3 md:col-span-4 col-span-4 row-span-2 lg:h-60 group transition">
                            ...
                            <div class="h-full sm:p-6 p-4 pt-2 lg:rounded-none md:rounded-tr-2xl md:rounded-b-none md:rounded-tl-none rounded-2xl flex items-end bg-gradient-to-t from-gray-900 overflow-hidden">
                                <div class="w-full translate-y-24 group-hover:translate-y-0 transition duration-500">
                                    ...
                                    <div class="relative pt-4 flex gap-2 group-hover:-mt-4 transition">
                                        <div
                                            class="translate-y-8 group-hover:translate-y-0 transition delay-150 duration-300 ease-in-out">
                                            <a href="{{ route('categories.show', $apartments[0]->key ) }}" class="block w-max py-2 px-6 border border-gray-600 text-white rounded-full hover:border-transparent hover:bg-white hover:text-purple-700 focus:bg-white focus:text-purple-700 active:scale-95 transition">
                                                <span class="text-sm font-medium tracking-wide">Savoir plus</span>
                                            </a>
                                        </div>
                        ...
                        <img src="{{ asset('storage/'.$apartments[0]->images ) }}" class="w-full h-full lg:rounded-none md:rounded-tr-2xl md:rounded-tl-none rounded-2xl object-cover" alt="{{ $apartments[0]->address }}">
                    </div>
                    ...
                    <div class="relative lg:col-span-3 md:col-span-4 col-span-4 row-span-2 lg:h-60 group transition">
                            ...
                            <div class="h-full sm:p-6 p-4 pt-2 flex items-end lg:rounded-tr-2xl md:rounded-none rounded-2xl bg-gradient-to-t from-gray-900 overflow-hidden">
                                <div class="w-full translate-y-24 group-hover:translate-y-0 transition duration-500">
                                    ...
                                    <div class="relative pt-4 flex gap-2 group-hover:-mt-4 transition">
                                        ...
                                        <div class="translate-y-16 group-hover:translate-y-0 transition delay-200 duration-300 ease-in-out">
                                            <a href="tel:{{ $apartments[1]->phoneNumber }}" aria-label="call" class="w-10 h-10 flex items-center rounded-full bg-purple-600 bg-opacity-0 hover:border-transparent hover:bg-opacity-30 focus:bg-opacity-40 active:scale-95 transition">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-4 m-auto text-purple-300" viewBox="0 0 16 16">
                                                    <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z" />
                                                </svg>
                                            </a>
                        ...
                        <img src="{{ asset('storage/'. $apartments[1]->images) }}" class="w-full h-full lg:rounded-tr-2xl md:rounded-none rounded-2xl object-cover" alt="{{ $apartments[1]->address }}">
                    </div>
                    ...
                    <div class="relative lg:col-span-4 md:col-span-7 col-span-5 row-span-2 lg:h-60 group transition">
                        ...
                        <img src="{{ asset('storage/'.$apartments[1]->images) }}" class="w-full h-full lg:rounded-none md:rounded-bl-2xl md:rounded-t-none md:rounded-br-none rounded-2xl object-cover" alt="{{ $apartments[1]->address }}">
                    </div>
                    ...
                    <div class="relative lg:col-span-2 md:col-span-5 col-span-3 row-span-2 lg:h-60 group transition">
                        ...
                        <img src="{{ asset('storage/'.$apartments[0]->images) }}" class="w-full h-full md:rounded-br-2xl md:rounded-t-none md:rounded-bl-none rounded-2xl object-cover" alt="{{ $apartments[0]->address }}">
                    </div>
                </div>
            </div>
        </div>
