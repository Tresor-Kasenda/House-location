<a  href="{{ route('categories.show', $apartment->key) }}" title="Voir les détails" class="block space-y-4 p-1 rounded-xl border hover:shadow-lg hover:rounded-2xl hover:border-transparent group transition duration-200">
    ...
    <div class="flex justify-between p-4 pt-2.5">
        <div>
            <h6 class="text-lg leading-none text-gray-700">{{ $apartment->piece_number ?? "" }} pieces</h6>
